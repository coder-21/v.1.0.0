	...
	<%if(request.getAttribute("SearchPerformed") == null 
     ...
     {%>
        <div class="row" id="dashboardErrorSection">
	        <div class="col-sm-4">
	    		<%if(request.getAttribute("isRegistrationsuccess") != null && request.getAttribute("isRegistrationsuccess").toString().matches("true")){%>
...
// 												List<Document[]> listOfCompanyDocArrforEachSharedUserList = (List<Document[]>) saveUserListService2.getListOfCompanyDocArrForEachSharedUserList(user);
												...
												for (int sharedListIndex = 0; sharedListIndex < listOfSharedUserListIds.size();sharedListIndex++) {%> 
											<Input id="hiddenListIdLabel" type="hidden"></input>
...
<!-- 			<button onclick="auth()">GET google CONTACTS FEED</button> -->
					...
					<TD><a
						...
						<TABLE cellspacing="0"><TR><TD style="border: none">
												<p style="" >You have no contacts to be displayed.</p>
											</TD></TR></TABLE>	
					<%}
					} %>
		</div>
...
<%-- 							<%}%> --%>
	  ...
	  <%}else if(request.getAttribute("SearchReturnedNull")!=null && request.getAttribute("SearchReturnedNull").toString().matches("true"))
