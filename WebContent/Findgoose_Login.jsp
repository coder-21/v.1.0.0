  ...
  <div class="container">
    ...
    <div id="navbar" class="navbar-collapse collapse">    	
      <ul class="nav navbar-nav navbar-right">
         <li class="active"><a href="FindGoose_WelcomePage.jsp"><i class="fa fa-home" aria-hidden="true"></i>Home</a></li>
        <li class="dropdown">
...
<div class="row" >
      <div class="col-sm-10 ">
          <div class="carousel-inner" role="listbox">
              <div class="client-say col-xs-4 col-sm-offset-5 ">
					 <form id="form" name="form" method="post" action="LoginServlet">
						<div class="form-group">
					        <h3 class="heading">Login</h3>
		        			<p class="timeline">Please enter the following credentials to log in.</p>
							<%if(request.getAttribute("UserLoggedOut") != null && request.getAttribute("UserLoggedOut") == "true"){
				    			request.removeAttribute("UserLoggedOut");%>
				 				<p style="color:green"> You have successfully Logged out! </p>
							<%}%>
							<div class="spacer"></div>
								<%if(request.getAttribute("isLoginError") != null && request.getAttribute("isLoginError") == "true"){%>
						 			<p style="color:red"> Login Failed due to mismatch in user credentials.<br> Please try again. </p>
								<%}%>
							<div class="spacer"></div>
								<input placeholder="User Email" class="form-control" type="text" name="email" id="email" required /> <br>
							 	<input placeholder="Password" type="password" class="form-control" name="password" id="password" required />
				<!-- 						<input type="checkbox" name="rememberMeCheck" value="true" alt="Remember Me"/>Remember Me. -->
								<input type="hidden" name="redirect" id="redirect" value="">
								<input type="hidden" name="isAjax" id="isAjax" value="1"> 
								<input type="hidden" name="isModal" id="isModal" value="0">
								<div class="modal-footer">
									<button class="btn-submit" type="submit">Sign-in</button>
								</div>			
								<div id="redirects" class="form-group">
									<a href="Registration">New User?</a>&nbsp<a href="Findgoose_forgotPassword.jsp" data-target="#forgotPasswordmodal" data-toggle="modal" >Forgot password??</a>
						 		</div>
								<div align="right"></div>
								<div class="spacer"></div>
						</div>
