...
<section class="search-section">
  <div class="container">
    <div class="row">
		<!-- Modal content-->
		<div class="form-group"><h3 class="heading">About Us</h3></div>
    <div class="modal-content">
      <div class="modal-header">
 		<h4 class="modal-title">FindGoose</h4>
 		</div>
 		<div class="modal-body">
      	<p>FindGoose is a robust platform that provides intelligent listings for smart decision making.</p>
        <p>We are the hub for enterprise teams,Corporate analysts, Investors and Entrepreneurs to discover, 
        evaluate, investigate and collaborate to enable meaningful business decisions. <br>
        FindGoose revolves around mutually helping Start-ups /Investors/ Enterprise Analysts in intelligently 
        connecting with each other using our data and platform.</p>
        <p>It has features like search, compare, follow, claim and interact.Enterprise groups get to 
        ...
        and they also license CRM tools to manage their watchlist and portfolio.</p>
        <p>A self-contained system that integrates the business need with intelligence to support smart and fast 
        decision making is the need for the day in today's tech savvy world.</p>
...
<!--         <h4 class="modal-title">Why our Logo?</h4> -->
      ...
      <div class="modal-body">
        ...
        <ul>
        <li><b>Email us @ : </b>contact.findgoose@gmail.com</li>
        <li><b>Location   : </b>Fremont, California</li>
        </ul>
      </div>
    </div>
    </div>
